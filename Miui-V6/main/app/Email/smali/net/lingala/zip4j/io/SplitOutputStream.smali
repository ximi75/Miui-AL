...
.method private startNextSplitFile()V
    ...
    const-string/jumbo v6, "split file: "
    ...
    const-string/jumbo v6, " already exists in the current directory, cannot rename this file"
    ...
    const-string/jumbo v5, "cannot rename newly created split file"
...
.method public checkBuffSizeAndStartNextSplitFile(I)Z
    ...
    const-string/jumbo v2, "negative buffersize for checkBuffSizeAndStartNextSplitFile"
...
.method public isBuffSizeFitForCurrSplitFile(I)Z
    ...
    const-string/jumbo v1, "negative buffersize for isBuffSizeFitForCurrSplitFile"

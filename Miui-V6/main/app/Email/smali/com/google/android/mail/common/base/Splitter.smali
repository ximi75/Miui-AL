...
.method private constructor <init>(Lcom/google/android/mail/common/base/Splitter$Strategy;)V
    .locals 2
    .param p1, "strategy"    # Lcom/google/android/mail/common/base/Splitter$Strategy;
...
.method private constructor <init>(Lcom/google/android/mail/common/base/Splitter$Strategy;ZLcom/google/android/mail/common/base/CharMatcher;)V
    ...
    .param p3, "trimmer"    # Lcom/google/android/mail/common/base/CharMatcher;
...
.method static synthetic access$000(Lcom/google/android/mail/common/base/Splitter;)Lcom/google/android/mail/common/base/Splitter$Strategy;
    .locals 1
    .param p0, "x0"    # Lcom/google/android/mail/common/base/Splitter;
...
.method public static fixedLength(I)Lcom/google/android/mail/common/base/Splitter;
    .locals 2
    .param p0, "length"    # I
    ...
    new-instance v1, Lcom/google/android/mail/common/base/Splitter$4;

    invoke-direct {v1, p0}, Lcom/google/android/mail/common/base/Splitter$4;-><init>(I)V
...
.method public static on(Lcom/google/android/mail/common/base/CharMatcher;)Lcom/google/android/mail/common/base/Splitter;
    .locals 2
    .param p0, "separatorMatcher"    # Lcom/google/android/mail/common/base/CharMatcher;
...
.method public static on(Ljava/lang/String;)Lcom/google/android/mail/common/base/Splitter;
    .locals 2
    ...
    new-instance v1, Lcom/google/android/mail/common/base/Splitter$2;

    invoke-direct {v1, p0}, Lcom/google/android/mail/common/base/Splitter$2;-><init>(Ljava/lang/String;)V
...
.method public static on(Ljava/util/regex/Pattern;)Lcom/google/android/mail/common/base/Splitter;
    .locals 4
    ...
    invoke-static {v0, v3, v1}, Lcom/google/android/mail/common/base/Preconditions;->checkArgument(ZLjava/lang/String;[Ljava/lang/Object;)V

    .line 209
    new-instance v0, Lcom/google/android/mail/common/base/Splitter;

    new-instance v1, Lcom/google/android/mail/common/base/Splitter$3;

    invoke-direct {v1, p0}, Lcom/google/android/mail/common/base/Splitter$3;-><init>(Ljava/util/regex/Pattern;)V
...
.method public static onPattern(Ljava/lang/String;)Lcom/google/android/mail/common/base/Splitter;
    .locals 1
    ...
    invoke-static {v0}, Lcom/google/android/mail/common/base/Splitter;->on(Ljava/util/regex/Pattern;)Lcom/google/android/mail/common/base/Splitter;
...
.method public split(Ljava/lang/CharSequence;)Ljava/lang/Iterable;
    ...
    .line 338
    new-instance v0, Lcom/google/android/mail/common/base/Splitter$5;

    invoke-direct {v0, p0, p1}, Lcom/google/android/mail/common/base/Splitter$5;-><init>(Lcom/google/android/mail/common/base/Splitter;Ljava/lang/CharSequence;)V

    return-object v0
.end method

.method public trimResults()Lcom/google/android/mail/common/base/Splitter;
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/mail/common/base/Splitter;->trimResults(Lcom/google/android/mail/common/base/CharMatcher;)Lcom/google/android/mail/common/base/Splitter;
...
.method public trimResults(Lcom/google/android/mail/common/base/CharMatcher;)Lcom/google/android/mail/common/base/Splitter;
    .locals 3
    .param p1, "trimmer"    # Lcom/google/android/mail/common/base/CharMatcher;
    ...
    iget-boolean v2, p0, Lcom/google/android/mail/common/base/Splitter;->omitEmptyStrings:Z

    invoke-direct {v0, v1, v2, p1}, Lcom/google/android/mail/common/base/Splitter;-><init>(Lcom/google/android/mail/common/base/Splitter$Strategy;ZLcom/google/android/mail/common/base/CharMatcher;)V

...
.method public static forPredicate(Lcom/google/android/mail/common/base/Predicate;)Lcom/google/android/mail/common/base/CharMatcher;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 517
    .local p0, "predicate":Lcom/google/android/mail/common/base/Predicate;, "Lcom/google/android/mail/common/base/Predicate<-Ljava/lang/Character;>;"
    invoke-static {p0}, Lcom/google/android/mail/common/base/Preconditions;->checkNotNull(Ljava/lang/Object;)Ljava/lang/Object;

    .line 518
    instance-of v0, p0, Lcom/google/android/mail/common/base/CharMatcher;

    if-eqz v0, :cond_0

    .line 519
    check-cast p0, Lcom/google/android/mail/common/base/CharMatcher;

    .line 521
    .end local p0    # "predicate":Lcom/google/android/mail/common/base/Predicate;, "Lcom/google/android/mail/common/base/Predicate<-Ljava/lang/Character;>;"
    :goto_0
    return-object p0

    .restart local p0    # "predicate":Lcom/google/android/mail/common/base/Predicate;, "Lcom/google/android/mail/common/base/Predicate<-Ljava/lang/Character;>;"
    :cond_0
    new-instance v0, Lcom/google/android/mail/common/base/CharMatcher$13;

    invoke-direct {v0, p0}, Lcom/google/android/mail/common/base/CharMatcher$13;-><init>(Lcom/google/android/mail/common/base/Predicate;)V
...
.method public static noneOf(Ljava/lang/CharSequence;)Lcom/google/android/mail/common/base/CharMatcher;
    .locals 1
    .param p0, "sequence"    # Ljava/lang/CharSequence;

    .prologue
    .line 478
    invoke-static {p0}, Lcom/google/android/mail/common/base/CharMatcher;->anyOf(Ljava/lang/CharSequence;)Lcom/google/android/mail/common/base/CharMatcher;

    move-result-object v0

    invoke-virtual {v0}, Lcom/google/android/mail/common/base/CharMatcher;->negate()Lcom/google/android/mail/common/base/CharMatcher;
...
.method public and(Lcom/google/android/mail/common/base/CharMatcher;)Lcom/google/android/mail/common/base/CharMatcher;
    ...
    .prologue
    .line 568
    new-instance v1, Lcom/google/android/mail/common/base/CharMatcher$And;
    ...
    invoke-direct {v1, v0}, Lcom/google/android/mail/common/base/CharMatcher$And;-><init>(Ljava/util/List;)V
...
.method public lastIndexIn(Ljava/lang/CharSequence;)I
    ...
    invoke-virtual {p0, v1}, Lcom/google/android/mail/common/base/CharMatcher;->matches(C)Z
...
.method public retainFrom(Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/mail/common/base/CharMatcher;->removeFrom(Ljava/lang/CharSequence;)Ljava/lang/String;

...
.method private addFolder(Ljava/io/File;Lnet/lingala/zip4j/model/ZipParameters;Z)V
    ...
    const-string/jumbo v2, "internal error: zip model is null"
    ...
    const-string/jumbo v2, "This is a split archive. Zip file format does not allow updating split/spanned files"
...
.method private readZipInfo()V
    ...
    const-string/jumbo v5, "zip file does not exist"
    ...
    const-string/jumbo v5, "no read access for the input zip file"
...
.method public addFiles(Ljava/util/ArrayList;Lnet/lingala/zip4j/model/ZipParameters;)V
    ...
    const-string/jumbo v2, "input file ArrayList is null, cannot add files"
    ...
    const-string/jumbo v2, "One or more elements in the input ArrayList is not of type File"
    ...
    const-string/jumbo v2, "input parameters are null, cannot add files to zip"
    ...
    const-string/jumbo v2, "invalid operation - Zip4j is in busy state"
    ...
    const-string/jumbo v2, "Zip file already exists. Zip file format does not allow updating split/spanned files"
...
.method public addFolder(Ljava/io/File;Lnet/lingala/zip4j/model/ZipParameters;)V
    ...
    const-string/jumbo v1, "input path is null, cannot add folder to zip file"
    ...
    const-string/jumbo v1, "input parameters are null, cannot add folder to zip file"
...
.method public addFolder(Ljava/lang/String;Lnet/lingala/zip4j/model/ZipParameters;)V
    ...
    const-string/jumbo v1, "input path is null or empty, cannot add folder to zip file"
...
.method public addStream(Ljava/io/InputStream;Lnet/lingala/zip4j/model/ZipParameters;)V
    ...
    const-string/jumbo v2, "inputstream is null, cannot add file to zip"
    ...
    const-string/jumbo v2, "zip parameters are null"
...
.method public createZipFile(Ljava/util/ArrayList;Lnet/lingala/zip4j/model/ZipParameters;ZJ)V
    ...
    const-string/jumbo v1, "zip file path is empty"
    ...
    const-string/jumbo v2, " already exists. To add files to existing zip file use addFile method"
    ...
    const-string/jumbo v1, "input file ArrayList is null, cannot create zip file"
    ...
    const-string/jumbo v1, "One or more elements in the input ArrayList is not of type File"
...
.method public createZipFileFromFolder(Ljava/io/File;Lnet/lingala/zip4j/model/ZipParameters;ZJ)V
    ...
    const-string/jumbo v1, "folderToAdd is null, cannot create zip file from folder"
    ...
    const-string/jumbo v1, "input parameters are null, cannot create zip file from folder"
    ...
    const-string/jumbo v2, " already exists. To add files to existing zip file use addFolder method"
...
.method public createZipFileFromFolder(Ljava/lang/String;Lnet/lingala/zip4j/model/ZipParameters;ZJ)V
    ...
    const-string/jumbo v1, "folderToAdd is empty or null, cannot create Zip File from folder"
...
.method public extractAll(Ljava/lang/String;Lnet/lingala/zip4j/model/UnzipParameters;)V
    ...
    const-string/jumbo v2, "output path is null or invalid"
    ...
    const-string/jumbo v2, "invalid output path"
    ...
    const-string/jumbo v2, "Internal error occurred when extracting zip file"
...
.method public extractFile(Ljava/lang/String;Ljava/lang/String;Lnet/lingala/zip4j/model/UnzipParameters;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "file to extract is null or empty, cannot extract file"
    ...
    const-string/jumbo v2, "destination string path is empty or null, cannot extract file"
    ...
    const-string/jumbo v2, "file header not found for given file name, cannot extract file"
...
.method public getComment(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 896
    const-string/jumbo p1, "windows-1254"
    ...
    const-string/jumbo v2, "zip model is null, cannot read comment"
    ...
    const-string/jumbo v2, "zip file does not exist, cannot read comment"
    ...
    const-string/jumbo v2, "end of central directory record is null, cannot read comment"
...
.method public getInputStream(Lnet/lingala/zip4j/model/FileHeader;)Lnet/lingala/zip4j/io/ZipInputStream;
    ...
    const-string/jumbo v2, "FileHeader is null, cannot get InputStream"
    ...
    const-string/jumbo v2, "zip model is null, cannot get inputstream"
...
.method public isEncrypted()Z
    ...
    const-string/jumbo v4, "Zip Model is null"
...
.method public isSplitArchive()Z
    ...
    const-string/jumbo v1, "Zip Model is null"
...
.method public mergeSplitFiles(Ljava/io/File;)V
    ...
    const-string/jumbo v2, "outputZipFile is null, cannot merge split files"
    ...
    const-string/jumbo v2, "output Zip File already exists"
    ...
    const-string/jumbo v2, "zip model is null, corrupt zip file?"
...
.method public removeFile(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "file name is empty or null, cannot remove file"
    ...
    const-string/jumbo v2, "Zip file format does not allow updating split/spanned files"
    ...
    const-string/jumbo v3, "could not find file header for file: "
...
.method public removeFile(Lnet/lingala/zip4j/model/FileHeader;)V
    ...
    const-string/jumbo v2, "file header is null, cannot remove file"
...
.method public setComment(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "input comment is null, cannot update zip file"
    ...
    const-string/jumbo v2, "zip file does not exist, cannot set comment for zip file"
    ...
    const-string/jumbo v2, "zipModel is null, cannot update zip file"
    ...
    const-string/jumbo v2, "end of central directory is null, cannot set comment"
...
.method public setPassword([C)V
    ...
    const-string/jumbo v2, "Zip Model is null"

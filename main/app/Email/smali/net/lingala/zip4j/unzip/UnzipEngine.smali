...
.method private checkLocalHeader()Z
    ...
    const-string/jumbo v5, "error reading local file header. Is this a valid zip file?"
...
.method private checkSplitFile()Ljava/io/RandomAccessFile;
    ...
    const-string/jumbo v7, "invalid first part split file signature"
...
.method private createFileHandler(Ljava/lang/String;)Ljava/io/RandomAccessFile;
    ...
    const-string/jumbo v3, "input parameter is null in getFilePointer"
...
.method public checkCRC()V
    ...
    const-string/jumbo v7, "invalid CRC for file: "
...
.method public getInputStream()Lnet/lingala/zip4j/io/ZipInputStream;
    ...
    const-string/jumbo v6, "file header is null, cannot get inputstream"
    ...
    .line 112
    const-string/jumbo v9, "local header and file header do not match"
    ...
    const-string/jumbo v6, "compression type not supported"
    ...
    const-string/jumbo v10, "invalid decryptor when trying to calculate compressed size for AES encrypted file: "
    ...
    const-string/jumbo v10, "AESExtraDataRecord does not exist for AES encrypted file: "
...
.method public startNextSplitFile()Ljava/io/RandomAccessFile;
    ...
    const-string/jumbo v5, "zip split file does not exist: "
...
.method public unzipFile(Lnet/lingala/zip4j/progress/ProgressMonitor;Ljava/lang/String;Ljava/lang/String;Lnet/lingala/zip4j/model/UnzipParameters;)V
    ...
    const-string/jumbo v6, "Invalid parameters passed during unzipping file. One or more of the parameters were null"

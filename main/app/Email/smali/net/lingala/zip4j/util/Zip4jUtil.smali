...
.method public static checkArrayListTypes(Ljava/util/ArrayList;I)Z
    ...
    const-string/jumbo v3, "input arraylist is null, cannot check types"
...
.method public static checkFileReadAccess(Ljava/lang/String;)Z
    ...
    const-string/jumbo v3, "cannot read zip file"
...
.method public static checkOutputFolder(Ljava/lang/String;)Z
    ...
    const-string/jumbo v4, "output path is null"
    ...
    const-string/jumbo v3, "output folder is not valid"
    ...
    const-string/jumbo v3, "no write access to output folder"
    ...
    const-string/jumbo v3, "Cannot create destination folder"
    ...
    const-string/jumbo v3, "no write access to destination folder"
...
.method public static detectCharSet(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v4, "input string is null, cannot detect charset"
...
.method public static getAbsoluteFilePath(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v2, "filePath is null or empty, cannot get absolute file path"
...
.method public static getEncodedStringLength(Ljava/lang/String;)I
    ...
    const-string/jumbo v2, "input string is null, cannot calculate encoded String length"
...
.method public static getEncodedStringLength(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string/jumbo v3, "input string is null, cannot calculate encoded String length"
    ...
    const-string/jumbo v3, "encoding is not defined, cannot calculate string length"
...
.method public static getFileHeader(Lnet/lingala/zip4j/model/ZipModel;Ljava/lang/String;)Lnet/lingala/zip4j/model/FileHeader;
    ...
    const-string/jumbo v3, "zip model is null, cannot determine file header for fileName: "
    ...
    const-string/jumbo v3, "file name is null, cannot determine file header for fileName: "
...
.method public static getFileHeaderWithExactMatch(Lnet/lingala/zip4j/model/ZipModel;Ljava/lang/String;)Lnet/lingala/zip4j/model/FileHeader;
    ...
    const-string/jumbo v6, "zip model is null, cannot determine file header with exact match for fileName: "
    ...
    const-string/jumbo v6, "file name is null, cannot determine file header with exact match for fileName: "
    ...
    const-string/jumbo v6, "central directory is null, cannot determine file header with exact match for fileName: "
    ...
    const-string/jumbo v6, "file Headers are null, cannot determine file header with exact match for fileName: "
...
.method public static getFileLengh(Ljava/io/File;)J
    ...
    const-string/jumbo v1, "input file is null, cannot calculate file length"
...
.method public static getFileNameFromFilePath(Ljava/io/File;)Ljava/lang/String;
    ...
    const-string/jumbo v1, "input file is null, cannot get file name"
...
.method public static getFilesInDirectoryRec(Ljava/io/File;Z)Ljava/util/ArrayList;
    ...
    const-string/jumbo v7, "input path is null, cannot read files in the directory"
...
.method public static getIndexOfFileHeader(Lnet/lingala/zip4j/model/ZipModel;Lnet/lingala/zip4j/model/FileHeader;)I
    ...
    const-string/jumbo v6, "input parameters is null, cannot determine index of file header"
    ...
    const-string/jumbo v6, "central directory is null, ccannot determine index of file header"
    ...
    const-string/jumbo v6, "file Headers are null, cannot determine index of file header"
    ...
    const-string/jumbo v6, "file name in file header is empty or null, cannot determine index of file header"
...
.method public static getLastModifiedFileTime(Ljava/io/File;Ljava/util/TimeZone;)J
    ...
    const-string/jumbo v1, "input file is null, cannot read last modified file time"
    ...
    const-string/jumbo v1, "input file does not exist, cannot read last modified file time"
...
.method public static getRelativeFileName(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v8, "input file path/name is empty, cannot calculate relative file name"
    ...
    const-string/jumbo v7, "file.separator"
    ...
    const-string/jumbo v8, "Error determining file name"
...
.method public static getSplitZipFiles(Lnet/lingala/zip4j/model/ZipModel;)Ljava/util/ArrayList;
    ...
    const-string/jumbo v8, "cannot get split zip files: zipmodel is null"
    ...
    const-string/jumbo v8, "cannot get split zip files: zipfile is null"
...
.method public static getZipFileNameWithoutExt(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v2, "zip file name is empty or null, cannot determine zip file name"
...
.method public static isSupportedCharset(Ljava/lang/String;)Z
    ...
    const-string/jumbo v2, "charset is null or empty, cannot check if it is supported"
...
.method public static setFileArchive(Ljava/io/File;)V
    ...
    const-string/jumbo v1, "input file is null. cannot set archive file attribute"
    ...
    const-string/jumbo v2, "attrib +A \""
...
.method public static setFileHidden(Ljava/io/File;)V
    ...
    const-string/jumbo v1, "input file is null. cannot set hidden file attribute"
    ...
    const-string/jumbo v2, "attrib +H \""
...
.method public static setFileSystemMode(Ljava/io/File;)V
    ...
    const-string/jumbo v2, "attrib +S \""

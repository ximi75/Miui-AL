.class public Lcom/kingsoft/emailcommon/Device;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/kingsoft/emailcommon/Device;->sDeviceId:Ljava/lang/String;
...
.method public static getConsistentDeviceId(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 112
    invoke-static {v0}, Lcom/kingsoft/emailcommon/utility/Utility;->getSmallHash(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v6, "Error in TelephonyManager.getDeviceId(): "
...
.method public static declared-synchronized getDeviceId(Landroid/content/Context;)Ljava/lang/String;
    ...
    .prologue
    .line 44
    const-class v1, Lcom/kingsoft/emailcommon/Device;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/kingsoft/emailcommon/Device;->sDeviceId:Ljava/lang/String;

    if-nez v0, :cond_0

    .line 45
    invoke-static {p0}, Lcom/kingsoft/emailcommon/Device;->getDeviceIdInternal(Landroid/content/Context;)Ljava/lang/String;
...
.method private static getDeviceIdInternal(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v7, "getDeviceId requires a Context"
    ...
    const-string/jumbo v7, "Can\'t delete null deviceName file; try overwrite."
    ...
    invoke-static {p0}, Lcom/kingsoft/emailcommon/Device;->getConsistentDeviceId(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v7, "androidc"
    ...
    const-string/jumbo v8, ": File exists, but can\'t read?"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    const-string/jumbo v8, "  Trying to remove."
    ...
    const-string/jumbo v7, "Remove failed. Tring to overwrite."

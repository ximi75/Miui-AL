...
.method static bigToLong(Ljava/math/BigInteger;)J
    ...
    const-string/jumbo v2, "The BigInteger cannot fit inside a 64 bit java long: ["
...
.method static longToBig(J)Ljava/math/BigInteger;
    ...
    const-string/jumbo v2, "Negative longs < -2^31 not permitted: ["
...
.method public static unsignedIntToSignedByte(I)B
    ...
    const-string/jumbo v2, "Can only convert non-negative integers between [0,255] to byte: ["
